...
class AnchorSpecV1:
    ...
    hash_alg: str = "sha256"
# Frozen default used by the retained V10 implementation
...
# =============================================================================
# NOTE: the literal "SSI-MedAI" prefix below is a legacy frozen
# domain-separation identifier inherited by the retained proof artifacts.
# It MUST NOT be renamed merely for cosmetic IoV branding, because doing so
# would change field elements, Merkle leaves, commitments, and existing proofs.
...
CONFORMANCE_VECTORS_V1: Dict[str, Any] = {
    "dp_record_v1_example": {
        ...
        "expected_sha256_hex": "e88109685a5ca83c72a3066eee3c13d2c316a77ecdee4ebbdeffe4491dcd8397",
    ...
    "client_update_envelope_v1_example": {
        "signed_obj": {
            ...
            "dp_record_sha256": "e88109685a5ca83c72a3066eee3c13d2c316a77ecdee4ebbdeffe4491dcd8397",
            "nonce": 42,
            "timestamp": 1700000000,
            "data_fingerprint_sha256": "",
        },
        "expected_signed_payload_sha256": "faf7fbc91ec335368fa8c1c2479a05ad32bb0be820b71d531bd330724cc51ba0",
        "envelope_obj": {
            "schema": "ClientUpdateEnvelopeV1",
            "did": "did:example:vehicle-1001",
            "rsu_id": 1,
            "round_idx": 1,
            "policy_id": "policy_v8b_rsu",
            "signed_payload_sha256": "faf7fbc91ec335368fa8c1c2479a05ad32bb0be820b71d531bd330724cc51ba0",
            "update_commit_sha256": "92439dd4e7652a0414d2cd9d220e8d2767ed71f9005327223fc5d12b7a5065c3",
            "dp_record_sha256": "e88109685a5ca83c72a3066eee3c13d2c316a77ecdee4ebbdeffe4491dcd8397",
            "nonce": 42,
            "timestamp": 1700000000,
        ...
        "expected_envelope_sha256": "d0604bd219daeb2578dc20ce0a5dded174aed9da12b6ab5581368df0985ab2fa",
        "expected_leaf_preimage_fields": [
            ...
            "17611597584384910490899413866065532974229296709647785863589674805863165821843",
            ...
            "4075146772142479047723807983086568599614160731609795785329575753840173849499",
        ],
    },
}
