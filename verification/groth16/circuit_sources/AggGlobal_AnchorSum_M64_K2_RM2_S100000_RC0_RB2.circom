...
template AnchorSum(M, KMAX, SCALE, NBITS) {
    ...
    signal mix;
    mix <== anchor_id + round_idx*1315423911 + global_id*2654435761 + K_used*97531 + root_poseidon_field*1580030173 + pins_hash_field*3266489917 + policy_id_field*668265263 + public_input_order_id_field*374761393;
...
component main { public [anchor_id, round_idx, global_id, K_used, root_poseidon_field, pins_hash_field, policy_id_field, public_input_order_id_field, r_chal, agg_commit] } = AnchorSum(64, 2, 100000, 32);
