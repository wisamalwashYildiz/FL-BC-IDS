#!/usr/bin/env python3
"""
Publication runner for the expanded 10-RSU / 200-vehicle topology.

Scientific topology/training constants match the retained V10 snapshot.
Dataset selection and path handling are publication-portable.
"""
...
# AnchorZKP: locate the reproducibility-repository root while keeping this
...
if _PROJECT_ROOT is None:
    raise RuntimeError(
        ...
        "Set FLBCIDS_REPO_ROOT to the reproducibility-repository root if needed."
    )
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = os.getenv(
        ...
        os.path.join(str(_PROJECT_ROOT), "artifacts", "06_expanded_topology", DATASET_NAME),
    )
